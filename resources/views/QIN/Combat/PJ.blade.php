...
@foreach($LstPerso as $Cle => $Perso)
    ...
    <div id="Ligne-{{$Cle}}" class="EcranLigne Ligne">
        ...
        <div id="LigneTrait-{{$Cle}}" class="EcranLigne">
        <div class="PersoDef">
            <div class="EcranPoint Colonne2-7">............ :</div>
            <div class="EcranLabel Colonne2-7">{{__("QIN/Combat.Trait")}}</div>
            <div id="Feu-{{$Cle}}" class="EcranCellule Feu Centre Numerique Colonne8-9"></div>
            <div id="Bois-{{$Cle}}" class="EcranCellule Bois Centre Numerique Colonne10-11"></div>
            <div id="Terre-{{$Cle}}" class="EcranCellule Terre Centre Numerique Colonne12-13"></div>
            <div id="Metal-{{$Cle}}" class="EcranCellule Metal Centre Numerique Colonne14-15"></div>
            <div id="Eau-{{$Cle}}" class="EcranCellule Eau Centre Numerique Colonne16-17"></div>
        </div>
        </div>

        <div id="LigneChi-{{$Cle}}" class="EcranLigne">
        <div class="PersoDef">
            <div class="EcranPoint Colonne2-5">...... :</div>
            <div class="EcranLabel Colonne2-5">{{__("QIN/Combat.CHI")}}</div>
            <div id="CHI-{{$Cle}}" class="EcranCellule Colonne6-7 Centre Numerique"></div>
        ...
        <div id="LigneTao-{{$Cle}}" class="EcranLigne">
        <div class="PersoDef">
        ...
        @switch($Perso->id_fonction)
            @case(0)
            @case(7)
                <div id="LignePV-{{$Cle}}" class="EcranLigne">
                <div class="PersoDef">
                    <div class="EcranPoint Colonne2-8">....... :</div>
                    <div class="EcranLabel Colonne2-8">{{__("QIN/Combat.PV")}}</div>
                    <div id="PV-{{$Cle}}" class="EcranCellule Colonne9-14 Centre Numerique">{{$Perso->PV}}</div>
                    <div id="Malus-{{$Cle}}" class="EcranCellule Colonne15-17 Centre Numerique"></div>
                </div>
                </div>
                @break
        @endswitch

        <div id="LigneDefense-{{$Cle}}" class="EcranLigne">
        <div class="PersoDef">
            <div class="EcranPoint Colonne2-8">. :</div>
            <div class="EcranLabel Colonne2-8">{{__("QIN/Combat.DefensePassive")}}</div>
            <div id="DefensePassive-{{$Cle}}" class="EcranCellule Colonne9-10 Centre Numerique"></div>
            <div class="EcranPoint Colonne11-15">. :</div>
            <div class="EcranLabel Colonne11-15">{{__("QIN/Combat.Resistance")}}</div>
            <div id="Resistance-{{$Cle}}" class="EcranCellule Colonne16-17 Centre Numerique">{{$Perso->Resistance}}</div>
        </div>
        </div>

        <div id="LigneDefendre-{{$Cle}}" class="EcranLigne">
        <div class="PersoDef">
        ...
        <div id="LigneArmure-{{$Cle}}" class="EcranLigne">
        <div class="PersoDef">
            <div class="EcranPoint Colonne2-6">..... :</div>
            <div class="EcranLabel Colonne2-6">{{__("Combat.Armure")}}</div>
            <div id="Armure-{{$Cle}}" class="EcranCellule Colonne7-8 Centre Numerique"></div>
            <select id="TypeArmure-{{$Cle}}" class="EcranSelect Colonne9-17">
            </select>
        </div>
        </div>

        <div id="LigneANaturel-{{$Cle}}" class="EcranLigne">
        <div class="PersoDef">
            <div id="ANaturel-{{$Cle}}" class="EcranCellule Colonne7-8 Centre Numerique"></div>
            <select id="TypeANaturel-{{$Cle}}" class="EcranSelect Colonne9-17">
            </select>
        </div>
        </div>

        <div id="LigneBouclier-{{$Cle}}" class="EcranLigne">
        <div class="PersoDef">
            <div class="EcranPoint Colonne2-6">..... :</div>
            <div class="EcranLabel Colonne2-6">{{__("Combat.Bouclier")}}</div>
            <div id="Bouclier-{{$Cle}}" class="EcranCellule Colonne7-8 Centre Numerique"></div>
            <select id="TypeBouclier-{{$Cle}}" class="EcranSelect Colonne9-17">
            </select>
        </div>
        </div>

        <div id="LigneInit-{{$Cle}}" class="EcranLigne">
        <div class="PersoDef">
            <div class="EcranPoint Colonne2-8">........... :</div>
        ...
        <div id="LigneCible-{{$Cle}}" class="EcranLigne">
        <div class="PersoDef">
            <div class="EcranPoint Colonne2-6">......... :</div>
        ...
        <div id="LigneAction-{{$Cle}}" class="EcranLigne">
        <div class="PersoDef">
            <div class="EcranPoint Colonne2-6">....... :</div>
        ...
        <div id="LigneTypeAttaque-{{$Cle}}" class="EcranLigne">
        <div class="PersoDef">
        ...
        <div id="LigneArme-{{$Cle}}" class="EcranLigne">
        <div class="PersoDef">
            <div class="EcranPoint Colonne2-6">........ :</div>
            <div class="EcranLabel Colonne2-6">{{__("Combat.Arme")}}</div>
            <div id="Arme-{{$Cle}}" class="EcranCellule Colonne7-8 Centre Numerique"></div>
            <select id="TypeArme-{{$Cle}}" class="EcranSelect Colonne9-17">
            </select>
        </div>
        </div>

        <div id="LignePosition-{{$Cle}}" class="EcranLigne">
        <div class="PersoDef">
            <div class="EcranPoint Colonne2-8">............. :</div>
            <div class="EcranLabel Colonne2-8">{{__("Combat.Position")}}</div>
            <div id="Position-{{$Cle}}" class="EcranCellule Colonne9-13 Centre Numerique"></div>
        </div>
        </div>
