...
@foreach($LstPerso as $Cle => $Perso)
    ...
    <div id="Ligne-{{$Cle}}" class="EcranLigne Ligne">
        ...
        @switch($Perso->id_fonction)
            ...
            @default
                @for($x = 0; $x < $NbPJ; $x++)
                    <div id="LignePV-{{$Cle}}-{{$x}}" class="EcranLigne">
                    <div class="PersoDef">
                        <div id="PJ-{{$Cle}}-{{$x}}" class="EcranLabel Colonne2-9">&#{{97+$x}}.</div>
                        <div id="Nb-{{$Cle}}-{{$x}}" class="EcranCellule Colonne11-12 Centre Numerique" enabled></div>
                        <button id="Moins-{{$Cle}}-{{$x}}" class="Bouton Colonne10" name="Action" value="Moins" type="submit">
                            <img height="16" src="../resources/Images/Bas.png" alt="Bas">
                        </button>
                        <button id="Plus-{{$Cle}}-{{$x}}" class="Bouton Colonne13" name="Action" value="Plus" type="submit">
                            <img height="16" src="../resources/Images/Haut.png" alt="Plus">
                        </button>
                        <div id="PV-{{$Cle}}-{{$x}}" class="EcranCellule Colonne14-17 Centre Numerique" enabled>{{$Perso->PV}}</div>
        ...
        <div class="PersoDef">
            ...
            <div id="Position-{{$Cle}}" class="EcranCellule Colonne9-13 Centre Numerique" enabled></div>
        </div>
        </div>
